...
<head>
  ...
  <title>Punta Cana Booking System  | Booking Details</title>
...
$query=mysqli_query($con,"select tblbookings.*, tblboat.ID,tblboat.CarName from tblbookings join tblboat on tblboat.ID=tblbookings.BoatID  where tblbookings.ID='$bid'");
$cnt=1;
...
?>
       ...
       <tr>
                  ...
                  <tr>
                    <th>Booking Date From - Bookingd Date To</th>
                 ...
                 <tr>
                  <th>Posting Date</th>
                    ...
                    <th>Car Name</th>
                    <td ><?php echo $result['CarName']?>  <a href='edit-boat.php?bid=<?php echo $result['BoatID']; ?>'> View Details</a></td>
                  </tr>
