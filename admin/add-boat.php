  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Car and Boat</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Add Car and Boat</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Car or Boat Details</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
   ...
   <div class="form-group">
                    <label for="exampleInputFullname">Name of Car or Boat</label>
                    <input type="text" class="form-control" id="boatname" name="boatname" placeholder="Enter Name of Car or Boat" required>
                  </div>
 ...
 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select class="form-control" name="size" required>
                      <option value="">Choose Size of Car or Boat</option>
...
<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="capacity" name="capacity" placeholder="Enter Capacity of Car or Boat" required>
                  </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" placeholder="Enter Description of Car or Boat" required></textarea>
                  </div>
