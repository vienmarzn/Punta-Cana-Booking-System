...
$route=$_POST['route'];
        ...
        if($result) {
            echo "<script>alert('Car or Boat detail updated successfully.');</script>";
...
<head>
  ...
  <title>Car or Boat Booking System  | Update Car or Boat</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Car or Boat</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Update Car or Boat</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Car or Boat Details</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" placeholder="Enter Description of Car or Boat" required><?php echo $result['Description'];?></textarea>
                  </div>
<?php } ?>
