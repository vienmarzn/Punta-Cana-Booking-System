...
if($query){
echo '<script>alert("Your Car booking request has been sent successfully. Booking number is "+"'.$bno.'")</script>';
...
echo "<script>alert('Car not available for these dates. Please select the diffrent dates');</script>";
}}
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <p><img src="images/van.webp" alt="Image" class="img-fluid"></p>
          </div>
          <div class="col-md-6">
            <span class="text-serif text-primary">Book Now</span>
            <h3 class="heading-92913 text-black">Book A Car</h3>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/Image.png');">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="text-white">Get In Touch With Us</h2>
            <p class="lead text-white">“Travel makes one modest, you see what a tiny place you occupy in the world.” ~ Gustave Flaubert</p>
