...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('images/Image1.jpg');"> <!--edited 1 -->
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 ml-auto text-right" data-aos="fade-up">
              <h1>Explore, Discover The Town La Union</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p>A transportation service that is easy to book for a better experience.</p>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/Image1.jpg');">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="counter-39392">
              <h3>200+</h3>
              <span>Number of Car</span>
            </div>
          </div>
          <div class="col">
            <div class="counter-39392">
...
?>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/Image2.0.png');">
      <div class="container">
