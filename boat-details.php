...
-->
            <h3 class="heading-92913 text-black">Car Details</h3>
                <p><strong>Car Name:</Strong>  <?php echo $result['CarName'];?></p>
                <p><strong>Car Size:</Strong>  <?php echo $result['Size'];?></p>
                <p><strong>Capacity of Car:</Strong>  <?php echo $result['Capacity'];?> persons.</p>
